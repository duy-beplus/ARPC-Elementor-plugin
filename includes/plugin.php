...
final class Plugin
{
	...
	public function admin_notice_missing_main_plugin()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" to be installed and activated.', 'community-elementor-addon'),
			'<strong>' . esc_html__('Community Elementor Addon', 'community-elementor-addon') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'community-elementor-addon') . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" version %3$s or greater.', 'community-elementor-addon'),
			'<strong>' . esc_html__('Flexbox Elementor Addon', 'community-elementor-addon') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'community-elementor-addon') . '</strong>',
	...
	public function admin_notice_minimum_php_version()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" version %3$s or greater.', 'community-elementor-addon'),
			'<strong>' . esc_html__('Flexbox Elementor Addon', 'community-elementor-addon') . '</strong>',
			'<strong>' . esc_html__('PHP', 'community-elementor-addon') . '</strong>',
	...
	public function register_widgets($widgets_manager)
	{
		...
		// //Custom query posts widget by Tuan
		// require_once(__DIR__ . '/widgets/custom-query-posts-widget.php');
		// $widgets_manager->register(new \Custom_Query_Posts_Widget());
